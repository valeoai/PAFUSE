...
def parse_args():
    ...
    parser.add_argument('--num_kps', default=17, type=int, help='number of keypoints in the dataset')
    parser.add_argument('--diff_model', default='MixSTE2', type=str, help='which diffusion backbone')
    ...
    parser.add_argument('--input_size', default=5, type=int, help='total number of 3d and 2d keypoint locations') # input_size * num_kps
